  ...
  _createClass(ActiveMenu, [{
    ...
    value: function addActive(navbarParam) {
      ...
      location.pathname[location.pathname.length - 1] == '/' ? navbarParam[0].classList.add(this.activeClass) : navbarParam.forEach(function (e) {
        if (e.attributes[1].value.includes('../') && e.attributes[1].value.slice(3) == _this.path) e.classList.add(_this.activeClass);
...
var Breadcrumb = /*#__PURE__*/function () {
  ...
  _createClass(Breadcrumb, [{
    ...
    value: function createBreadcrumb(element) {
      var createLiElement;
      this.breadcrumb.innerHTML = "<li class=\"breadcrumb-item\"><a href=\"".concat(this.breadcrumbHome.slice(location.pathname.lastIndexOf('/') + 1), "\">").concat(this.homeTitle, "</a></li>");
      ...
      document.addEventListener('DOMContentLoaded', function () {
        if (typeof _this.buttonSend !== 'undefined' && _this.buttonSend !== null) {
          _this.buttonSend.addEventListener('click', function (event) {
            ...
            _this.ajaxRequest('POST', './sendmail.php', postdata, function (success, response) {
              if (success) {
